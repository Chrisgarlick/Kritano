# Video Captions — How Many Scripts
...
How many scripts is YOUR website loading?

We ran a scan on a typical e-commerce site and found 127 scripts running on a single page. Analytics trackers, chat widgets, social pixels, tag managers — each one adding load time and security risk.

Here's what 127 scripts actually costs you:
+4.2 seconds of extra load time
