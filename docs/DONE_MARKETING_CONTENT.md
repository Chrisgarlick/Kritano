...
|----------|-----------|-------|
| Twitter/X | 1 post per day (7/week) | Short-form tips, stats, engagement |
| Instagram | 1 post per day (7/week) | Carousels, infographics, reels scripts |
| Threads | 1 post per day (7/week) | Conversational, community-driven |
| LinkedIn | 2 posts per week | Long-form thought leadership |
| Blog | 2 posts per week | SEO-driven articles, guides, case studies |

### Content Pillars

1. **Education** — Accessibility, SEO, security, and performance tips
2. **Product** — Features, demos, behind-the-scenes
3. **Social Proof** — Stats, testimonials, case studies
4. **Community** — Engagement, questions, discussions
5. **Industry** — News, trends, regulatory updates (WCAG, EAA, ADA)

### Tone

Authoritative but approachable. Data-driven. Helpful. Never preachy. Always action-oriented — "here's what you can do."
...
**Goal:** Establish the market problem. Make people realise their websites have issues they don't know about.

#### Twitter/X (Daily)

| Day | Post |
|-----|------|
| Mon | 96% of the world's top 1 million websites have accessibility issues. Your site probably does too. We're building something to fix that. More soon. |
| Tue | Quick test: go to your website and try navigating it with just your keyboard. Tab through every link, button, and form. How far did you get? Most sites break within 3 clicks. |
| Wed | "Our website is fine" — every business owner before they run an audit. The average site has 50+ accessibility issues across just the homepage. |
| Thu | Google now uses Core Web Vitals as a ranking factor. If your site is slow, poorly structured, or inaccessible — you're losing rankings AND customers. |
| Fri | 1 in 4 adults in the UK has a disability. If your website isn't accessible, you're excluding 25% of your potential customers. That's not just an ethical issue — it's a business one. |
| Sat | Fun fact: the European Accessibility Act kicks in June 2025. If you sell to EU customers, your website legally needs to be accessible. Are you ready? |
| Sun | We've been auditing websites for months now. The most common issue? Missing alt text on images. It takes 5 seconds to fix. But most businesses don't even know it's a problem. |
...
| Day | Post |
|-----|------|
| Mon | Hot take: most businesses have no idea their website is broken for 25% of their audience. Accessibility isn't a nice-to-have — it's table stakes. |
| Tue | Tried using just my keyboard to navigate 10 popular websites today. 7 of them were completely unusable after the homepage. We have a long way to go. |
| Wed | Unpopular opinion: automated accessibility tools catch maybe 30-40% of issues. But that 30-40% is still better than the 0% most businesses are catching right now. |
| Thu | SEO tip most people miss: heading hierarchy matters more than you think. H1 → H2 → H3. Skip levels and Google gets confused about your content structure. |
| Fri | The cost of an ADA lawsuit averages $25,000-$75,000 for a small business. The cost of making your site accessible? A fraction of that. Prevention > cure. |
| Sat | Question for devs: what's the most common accessibility issue you see in the wild? I'll go first — form inputs without associated labels. |
| Sun | Building something that makes website auditing actually useful. Not just a list of errors — real guidance on what to fix and why. Coming soon. |
...
**Blog 1:** "The State of Web Accessibility in 2026: Why 96% of Websites Are Still Failing"
...
**Blog 2:** "What Google Actually Looks At: A Plain-English Guide to Core Web Vitals"
...
| Day | Post |
|-----|------|
| Mon | Accessibility tip #1: Every image on your site needs alt text. Decorative images? Use alt="". Meaningful images? Describe what the image conveys, not what it looks like. |
| Tue | SEO myth: "More pages = better rankings." Reality: 10 excellent pages outperform 100 mediocre ones every time. Google rewards depth, not volume. |
| Wed | Security check: Is your site still loading mixed content (HTTP resources on an HTTPS page)? That padlock in the browser bar might not mean what you think it means. |
| Thu | The average website loads 22 third-party scripts. Each one is a potential performance bottleneck AND a security risk. When did you last audit yours? |
| Fri | Colour contrast ratio cheat sheet: Normal text: 4.5:1 minimum. Large text (18px+): 3:1 minimum. Your brand colours might look great but fail accessibility. Check them. |
| Sat | Most underrated SEO element: the meta description. It doesn't directly affect rankings, but a well-written one can double your click-through rate from search results. |
| Sun | Building in public update: This week we've been refining our scoring algorithm. How do you weigh a critical accessibility issue vs a minor SEO suggestion? It's harder than you'd think. |

#### Instagram (Daily)

| Day | Type | Content |
|-----|------|---------|
| Mon | Carousel | "Alt Text: The Complete Guide" — What it is, why it matters, good vs bad examples, decorative vs meaningful images. 8 slides. |
| Tue | Infographic | "SEO Myths vs Reality" — 5 common myths debunked with data. Clean, shareable format. |
| Wed | Carousel | "Is Your Site Actually Secure?" — SSL, mixed content, exposed admin panels, outdated CMS, open ports. Security checklist. |
...
| Day | Post |
|-----|------|
| Mon | Alt text tip: don't just describe the image. Describe the PURPOSE of the image. A photo of a team meeting isn't "people sitting at a table" — it's "our design team collaborating on the new dashboard." Context matters. |
| Tue | SEO hot take: if your content doesn't answer a question someone is actually asking, it doesn't matter how optimised it is. Search intent > keyword density. Every time. |
| Wed | Quick security audit you can do right now: 1) Visit your site 2) Add /wp-admin or /admin to the URL 3) If you see a login page, your admin panel is publicly accessible. Fix that. |
| Thu | The web would be 40% faster if every website just lazy-loaded their images. It's literally one attribute: loading="lazy". Why aren't we all doing this? |
| Fri | Designers: I love your brand colours. But if your primary button is light grey text on a white background, you're excluding millions of people. Run your colours through a contrast checker. |
| Sat | Meta description writing formula: [What the page is about] + [key benefit] + [call to action]. Keep it under 155 characters. Simple but effective. |
| Sun | Building update: spent this week on the scoring algorithm. A site with one critical accessibility issue shouldn't score the same as a site with fifty minor ones. Weighting matters. |
...
>
> **Who it applies to:**
> Any business selling to EU consumers with a digital presence. E-commerce, SaaS, banking, transport, media.
>
> **What it requires:**
> Your website must meet WCAG 2.1 AA standards. That means perceivable, operable, understandable, and robust for all users, including those with disabilities.
>
> **What happens if you don't comply:**
> Each EU member state sets its own penalties, but expect fines, market access restrictions, and potential lawsuits.
>
...
**Blog 1:** "The Complete Guide to Image Alt Text: What It Is, Why It Matters, and How to Write It"
...
**Blog 2:** "Website Security Basics Every Business Owner Should Know"
...
**Blog 1:** "Why Your Website Needs Regular Health Checks (Not Just an Annual Audit)"
...
**Goal:** Maximum anticipation. Countdown to launch. Final waitlist push. Behind-the-scenes content.
...
| Sun | Launch eve graphic | "Tomorrow. Your website health score awaits." |
...
**Blog 1:** "Understanding Website Accessibility Scores: What the Numbers Actually Mean"
...
**Blog 2:** "The Website Launch Checklist: 25 Things to Check Before Going Live"
...
## Month 2: Launch (Awareness, Activation & Social Proof)

**Theme:** Drive sign-ups, showcase the product, share early user results, celebrate milestones.

**Campaign label:** `Launch`
...
| Fri | Stats graphic | Launch week numbers — audits run, issues found, top findings. |
| Sat | Reel | Before/after: show a website's score before fixes, make 3 quick fixes, show the improved score. |
| Sun | Thank you graphic | "Thank you to our launch week users" — community appreciation post. |
...
**Blog 2:** "What We Learned From Auditing 1,000 Websites: The Data"
- Aggregate findings from launch week
...
| Day | Type | Content |
|-----|------|---------|
| Mon | Before/after graphic | User's score improvement with key fixes highlighted. |
| Tue | Carousel | "Developer vs Accessibility Specialist" — what each catches, why automated tools fill the gap. Not adversarial — complementary. |
| Wed | Infographic | "WCAG 2.1 AA: The Key Criteria" — visual breakdown of the main success criteria. |
| Thu | Interactive story | Poll: "What do you think your website's weakest area is?" Accessibility / SEO / Security / Performance |
| Fri | Screenshot | New comparison feature preview. Side-by-side audit results. |
| Sat | Carousel | "The Accessibility-SEO Connection" — 5 ways accessible sites rank better. Data-backed. |
| Sun | Community spotlight | Reshare/feature a user who improved their score with a quote. |
...
**Blog 1:** "How to Improve Your Website Accessibility Score by 20+ Points in Under 2 Hours"
- The quick wins: alt text, contrast, headings, form labels
...
| Day | Type | Content |
|-----|------|---------|
| Mon | Mockup | PDF report preview with callout annotations. Show the quality. |
...
**Blog 2:** "Image Optimisation: The Single Biggest Performance Win for Most Websites"
...
**Blog 1:** "How to Use Website Audits in Your Agency Sales Process"
...
**Blog 2:** "Month 1 Data: What 10,000 Website Audits Reveal About the State of the Web"
...
## Month 3: Post-Launch (Growth, Retention & Authority)

**Theme:** Establish thought leadership, deepen engagement, drive upgrades, build community.

**Campaign label:** `Growth`
...
| Day | Post |
|-----|------|
| Mon | E-commerce accessibility matters more than you think. If your product images don't have alt text, screen reader users can't shop your store. That's revenue you're leaving on the table. |
| Tue | We analysed 500 restaurant websites. Average accessibility score: 38/100. Most common issue: menu PDFs that aren't screen-readable. Your menu should be HTML, not a PDF. |
...
| Day | Type | Content |
|-----|------|---------|
| Mon | Carousel | "E-commerce Accessibility Essentials" — product images, checkout flow, filters, search. |
| Tue | Infographic | "Restaurant Website Audit: The Data" — average scores, top issues, quick fixes. |
| Wed | Carousel | "Law Firm Website Analysis" — good security, poor performance. What to learn. |
| Thu | Infographic | "SaaS Website Benchmarks" — how tech companies score across all four dimensions. |
| Fri | Data graphic | "Accessible sites have 23% lower bounce rates" — the business case for accessibility. |
| Sat | Teaser | "Industry benchmarks coming soon" — preview graphic. |
| Sun | Interactive story | Poll: "What industry should we analyse next?" |

#### Threads (Daily)

| Day | Post |
|-----|------|
| Mon | If you run an e-commerce store and your product images don't have alt text, you're telling blind and low-vision shoppers that your products aren't for them. Fix this. It takes minutes per product. |
| Tue | Audited 500 restaurant websites this week. Average accessibility score: 38. The biggest issue? Menus as PDFs. Screen readers can't read image-based PDFs. Make your menu HTML. |
...
**Post 1 (Tue):**
> **Industry Report: We Audited 500 E-Commerce Websites. Here's What We Found.**
>
> E-commerce and website accessibility should go hand-in-hand. Your online store is only as good as its ability to serve all customers.
>
...
>
> Full report available on our blog. Link in comments.
...
>
> Accessibility isn't a cost centre. It's a revenue driver.

#### Blog (2x/week)

**Blog 1:** "E-Commerce Accessibility: A Complete Guide for Online Retailers"
...
**Blog 2:** "Website Performance Benchmarks by Industry: Where Does Your Site Stand?"
- Performance data across industries
- What's considered "good" for each sector
...
| Fri | Feature announcement | Slack integration live. "Your website health, in your team chat." |
| Sat | Carousel | "Setting Up Health Thresholds" — walkthrough of the threshold/alerting feature. |
| Sun | Interactive | "What should we build next?" — community poll or story questions. |
...
>
> Documentation and examples at [link]. Free tier includes API access with rate limits.

**Post 2 (Fri):**
> **From Reactive to Proactive: The Shift in Website Health Management**
>
> The old way: wait for complaints, fix issues, repeat.
>
...
>
> The businesses that win on the web aren't the ones with the best launch. They're the ones with the best maintenance.
...
**Blog 2:** "WCAG 2.2: What's New and What It Means for Your Website"
- New success criteria explained
- Focus appearance, dragging, redundant entry
...
**Post 1 (Wed):**
> **The Accessibility Adoption Curve: Where Are We?**
>
> Every technology standard follows an adoption curve. Mobile responsiveness went from "nice to have" (2010) to "table stakes" (2016) in about 6 years.
>
...
> - More integrations
>
> Thank you for an incredible first quarter. The web is getting better, one audit at a time.

#### Blog (2x/week)

**Blog 1:** "The Business Case for Web Accessibility: Data, ROI, and Real-World Results"
- Revenue impact data
- Lawsuit prevention
- SEO correlation
...
**Blog 2:** "10 Web Accessibility Trends to Watch in 2026"
- Regulatory landscape
- AI and accessibility
- Overlay tools controversy
...
| Type | Per Week | 12 Weeks | Total |
|------|----------|----------|-------|
| Twitter/X | 7 | 84 | **84 posts** |
| Instagram | 7 | 84 | **84 posts** |
| Threads | 7 | 84 | **84 posts** |
| LinkedIn | 2 | 24 | **24 posts** |
| Blog | 2 | 24 | **24 articles** |
| **Total** | **25** | **300** | **300 pieces of content** |
...
|---------------|-------|-------|
| Pre-Launch | `#6366f1` (indigo) | 1-4 |
| Launch | `#f59e0b` (amber) | 5-8 |
| Growth | `#22c55e` (green) | 9-12 |

---

## Notes

- All Twitter/X posts are under 280 characters unless marked as threads
