...
## Variation 2 — Dark with Stacked Pages

**Caption:**
Reports your clients will actually read.

Not a wall of error codes. Not a data dump. A proper document with:
→ What's broken
→ Why it matters
→ How to fix it
...
## Variation 3 — Brand Indigo with Feature Grid

**Caption:**
Every audit. Export-ready.

PDF for branded client reports. CSV for spreadsheet analysis and JIRA imports. Both include scores, findings, severity levels, and fix guidance.
