# Captions — Dashboard Preview

## Variation 1 — Light with Full Mockup
...
## Variation 2 — Dark with Score Cards

**Caption:**
Scores that actually mean something.

Not just a number — each score breaks down into specific issues, ranked by severity, with plain-English guidance on what to fix. No guessing. No Googling error codes.
...
## Variation 3 — Brand Indigo with Score Rings + Issues

**Caption:**
Four scores. One dashboard. Zero jargon.

SEO: 92. Accessibility: 78. Security: 95. Performance: 83.

Behind every number is a list of issues — prioritised by severity, explained in plain English, with step-by-step fix guidance.

Every issue. Explained. Prioritised. Fixable.
