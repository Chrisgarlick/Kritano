# Captions — Dashboard Sneak Peek

## Variation 1 — Light with Full Dashboard

**Caption:**
Sneak peek at what we've been building.

SEO, accessibility, security, and performance — all in one view. Real scores, real issues, real guidance on what to fix first.
...
One dashboard. Every metric that matters. SEO, accessibility, security, performance — scored, tracked, and explained in plain English.
...
## Variation 3 — Brand Indigo with Floating Cards

**Caption:**
Sneak peek at what we've been building. Stay tuned.
