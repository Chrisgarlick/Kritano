              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    {template.is_system && (
                      <span className="text-xs px-2 py-0.5 rounded-full bg-white/[0.06] text-slate-400 flex items-center gap-1">
                ...
                <p className="text-sm text-slate-400 mb-1 truncate" title={template.subject}>
                ...
                <div className="text-xs text-slate-500 mb-3">
                  Slug: <code className="text-slate-400">{template.slug}</code>
                </div>
                ...
                <div className="flex items-center gap-1 pt-3 border-t border-white/[0.04]">
                  ...
                  {!template.is_system && (
                    <button
                      ...
                      className="p-1.5 text-slate-400 hover:text-red-400 transition-colors ml-auto"
                      title="Delete"
                    >
