        ...
        structuredData={[
          {
            ...
            '@type': 'WebPage',
            name: 'Kritano API Documentation',
            description: 'Comprehensive API documentation for Kritano - automate website audits, retrieve findings, and build custom integrations.',
            url: 'https://kritano.com/docs',
          },
          {
            '@context': 'https://schema.org',
            '@type': 'BreadcrumbList',
      ...
      <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 text-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-700 border border-slate-600 text-sm font-medium mb-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link to="/app/settings/api-keys" className="px-5 py-3 bg-slate-700 border border-slate-600 text-white rounded-lg font-semibold text-sm hover:bg-slate-600 transition-colors">
                Get API Key
              </Link>
            </div>
          </div>
