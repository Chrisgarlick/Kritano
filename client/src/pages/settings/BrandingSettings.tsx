...
export default function BrandingSettings() {
  ...
  return (
    <>
      <Helmet><title>Branding | Kritano</title></Helmet>
          ...
          <div className="p-6 space-y-5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-500 mt-1">
                Shown at the bottom of every PDF page. Leave blank to use "Generated by Kritano".
              </p>
            </div>
        ...
        <ul className="text-sm text-indigo-700 dark:text-indigo-400 space-y-1.5">
          ...
          {isAgencyPlus && (
            <>
              ...
              <li className="flex items-start gap-2">
                <Check className="w-4 h-4 mt-0.5 flex-shrink-0" />
                <span>Custom footer text replaces "Generated by Kritano" (Agency/Enterprise)</span>
              </li>
              <li className="flex items-start gap-2">
                <Check className="w-4 h-4 mt-0.5 flex-shrink-0" />
