 ...
 * About Page
 *
 * Company story, mission, and values for Kritano.
 */
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-20 pt-20 lg:pt-28 pb-16">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
            Kritano was born from a simple observation: most website owners don't know what's
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              We're here to change that. Kritano gives businesses of all sizes the same
      ...
      <section className="bg-slate-50 dark:bg-slate-800/50 border-y border-slate-200 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-6 lg:px-20 py-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="font-display text-4xl text-slate-900 dark:text-white leading-tight mb-8">
              From frustration to solution
            </h2>
            <div className="text-left space-y-6 text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              <p>
                Kritano started when our founder ran accessibility audits on client websites
              ...
              <p>
                So we built Kritano: a platform that runs comprehensive audits in under
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-20 py-24">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/contact"
              className="px-8 py-4 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-semibold transition-colors flex items-center gap-2"
            >
              Get in Touch
