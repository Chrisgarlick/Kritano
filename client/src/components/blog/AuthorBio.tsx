...
const AUTHOR = {
  ...
  bio: 'I built Kritano after years of running audits with fragmented tools. I write about SEO, accessibility, security, and performance based on real auditing data from thousands of scans.',
  credentials: '5 years in web development. I specialise in web auditing, WCAG 2.2 compliance, and search engine optimisation.',
};
