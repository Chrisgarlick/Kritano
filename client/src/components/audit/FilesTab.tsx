          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                ...
                <th className="text-left text-xs font-medium text-slate-500 dark:text-slate-400 px-4 py-3">File</th>
                <th className="text-right text-xs font-medium text-slate-500 dark:text-slate-400 px-4 py-3">Size</th>
                <th className="text-center text-xs font-medium text-slate-500 dark:text-slate-400 px-4 py-3">Pages</th>
                <th className="text-center text-xs font-medium text-slate-500 dark:text-slate-400 px-4 py-3">Source</th>
                          ...
                          <div className="flex-1 min-w-0 px-3">
                            <div className="flex items-center gap-2">
                              ...
                              {asset.file_extension && (
                                <span className="px-1.5 py-0.5 text-[10px] font-mono font-medium bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 rounded">
                                  .{asset.file_extension}
                                </span>
                              )}
                              <a
                            ...
                            <p className="text-xs text-slate-400 dark:text-slate-500 truncate mt-0.5 max-w-md">
                              {asset.url}
                            </p>
                          </div>

                          {/* Size */}
                          <div className="w-20 text-right text-sm text-slate-600 dark:text-slate-400 flex-shrink-0">
