...
exports.COOKIE_CATEGORIES = exports.COOKIE_CONSENT_VERSION = exports.RATE_LIMIT_PROFILES = exports.SCANNER_INFO = exports.VERIFICATION_LIMITS = exports.VERIFICATION_DNS_SUBDOMAIN = exports.VERIFICATION_FILE_PATH = exports.VERIFICATION_TOKEN_PREFIX = exports.LEGAL_URLS = exports.CONSENT_CHECKBOX_TEXTS = exports.UNVERIFIED_DOMAIN_CONSENT_TEXT = exports.TOS_VERSION = exports.CONSENT_VERSION = exports.VERIFIED_DOMAIN_DEFAULTS = exports.UNVERIFIED_DOMAIN_LIMITS = void 0;
exports.getConsentTextHash = getConsentTextHash;
const crypto_1 = require("crypto");
/**
 * Scan limits for unverified domains
 * These are enforced to protect both the target site and our liability
 */
exports.UNVERIFIED_DOMAIN_LIMITS = {
 ...
 */
exports.VERIFIED_DOMAIN_DEFAULTS = {
    MAX_PAGES: 100,
    MIN_DELAY_MS: 500,
    CONCURRENT_PAGES: 3,
};
...
4. This scan will be limited to ${exports.UNVERIFIED_DOMAIN_LIMITS.MAX_PAGES} pages maximum with reduced crawl speed for safety.
 ...
 */
exports.CONSENT_CHECKBOX_TEXTS = {
 ...
 */
function getConsentTextHash(version = exports.CONSENT_VERSION) {
    const text = exports.UNVERIFIED_DOMAIN_CONSENT_TEXT + version;
    return (0, crypto_1.createHash)('sha256').update(text).digest('hex').substring(0, 64);
}
/**
 ...
 */
exports.VERIFICATION_TOKEN_PREFIX = 'kritano-verify=';
/**
 * Well-known path for file-based verification
 */
exports.VERIFICATION_FILE_PATH = '/.well-known/kritano-verify.txt';
/**
 * DNS TXT record subdomain for verification (alternative to root domain)
 */
exports.VERIFICATION_DNS_SUBDOMAIN = '_kritano';
/**
 * Verification attempt limits
 */
exports.VERIFICATION_LIMITS = {
 ...
 */
exports.COOKIE_CONSENT_VERSION = '1.0';
/**
...
//# sourceMappingURL=consent.constants.js.map