...
exports.CQS_WEIGHTS = void 0;
exports.getCqsImpact = getCqsImpact;
exports.CQS_WEIGHTS = {
    quality: 0.25,
    eeat: 0.25,
    readability: 0.20,
 ...
 */
function getCqsImpact(ruleId) {
    const subScores = impactMap[ruleId];
    if (!subScores)
        return null;
    const weight = subScores.reduce((sum, s) => sum + exports.CQS_WEIGHTS[s], 0);
    return { subScores, weight };
}
//# sourceMappingURL=cqs-impact-map.js.map