 ...
 */
export type PostCategory = 'seo' | 'accessibility' | 'security' | 'performance' | 'content-quality' | 'structured-data' | 'eeat' | 'aeo' | 'guides' | 'case-studies' | 'product-updates';
export type PostStatus = 'draft' | 'published' | 'archived';
export type BlockType = 'text' | 'heading' | 'image' | 'two_column' | 'callout' | 'code' | 'quote' | 'divider' | 'embed' | 'cta' | 'stat_highlight' | 'audit_link';
