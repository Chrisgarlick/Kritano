...
exports.getRandomHeaders = getRandomHeaders;
 ...
 */
function getRandomViewport(type = 'desktop') {
    const viewports = exports.VIEWPORTS[type];
 ...
 */
function getRandomHeaders(userAgentConfig) {
    const headers = {
 ...
 */
function generateFingerprint(type = 'desktop') {
...
//# sourceMappingURL=user-agents.service.js.map