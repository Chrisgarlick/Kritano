...
exports.UrlNormalizerService = void 0;
exports.createUrlNormalizer = createUrlNormalizer;
...
class UrlNormalizerService {
    targetDomain;
    includeSubdomains;
    constructor(targetDomain, includeSubdomains = false) {
     ...
     */
    hashUrl(normalizedUrl) {
        return crypto_1.default.createHash('sha256').update(normalizedUrl).digest('hex');
    }
    /**
...
exports.UrlNormalizerService = UrlNormalizerService;
/**
 * Create a URL normalizer for a specific target
 */
function createUrlNormalizer(targetUrl, includeSubdomains = false) {
    return new UrlNormalizerService(targetUrl, includeSubdomains);
}
//# sourceMappingURL=url-normalizer.service.js.map