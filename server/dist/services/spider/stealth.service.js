...
exports.STEALTH_EVASION_SCRIPT = exports.STEALTH_BROWSER_ARGS = void 0;
exports.applyStealthToContext = applyStealthToContext;
exports.applyStealthToPage = applyStealthToPage;
exports.verifyStealthActive = verifyStealthActive;
/**
 * Additional browser launch arguments for stealth mode
 */
exports.STEALTH_BROWSER_ARGS = [
 ...
 */
exports.STEALTH_EVASION_SCRIPT = `
  // ===========================================
...
async function applyStealthToContext(context) {
    ...
    await context.addInitScript(exports.STEALTH_EVASION_SCRIPT);
}
/**
...
async function applyStealthToPage(page) {
    await page.addInitScript(exports.STEALTH_EVASION_SCRIPT);
}
/**
 * Verify stealth is working by checking navigator.webdriver
 */
async function verifyStealthActive(page) {
    try {
