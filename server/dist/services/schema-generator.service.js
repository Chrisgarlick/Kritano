...
exports.generateSchemaForPage = generateSchemaForPage;
exports.generateSchemaForSite = generateSchemaForSite;
// Helpers to create shared references
function makeWebSiteRef(ctx) {
    return {
        '@type': 'WebSite',
...
function generateHomepage(data, childPages) {
    const webSite = {
        '@type': 'WebSite',
...
function generateArticle(data, ctx) {
    return [
        {
            '@type': 'Article',
...
function generateProduct(data, ctx) {
    return [
        {
            '@type': 'Product',
...
function generateWebPage(data, ctx) {
    return [
        {
            '@type': 'WebPage',
...
function buildGraphItems(data, ctx, childPages) {
 ...
 */
function generateSchemaForPage(data, ctx) {
    const pageType = data.detectedPageType || 'default';
    const siteCtx = ctx || {
 ...
 */
function generateSchemaForSite(pages) {
