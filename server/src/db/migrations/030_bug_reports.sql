...
COMMENT ON TABLE bug_reports IS 'User-submitted bug reports for the application';
COMMENT ON TABLE bug_report_comments IS 'Comments/communication on bug reports between users and admins';
COMMENT ON COLUMN bug_reports.severity IS 'User-reported severity: critical, major, minor, trivial';
COMMENT ON COLUMN bug_reports.priority IS 'Admin-assigned priority: urgent, high, medium, low';
COMMENT ON COLUMN bug_reports.status IS 'Report status: open, in_progress, resolved, closed';
