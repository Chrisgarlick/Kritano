...
export const VITE_CSS_PATH = discoverCssFile();

export const BASE_URL = process.env.APP_URL?.replace(/^http:\/\//, 'https://') || 'https://kritano.com';
...
export function setSsrHeaders(res: Response): void {
...
export function renderAuthorBio(): string {
