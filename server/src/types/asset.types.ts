// Asset categories for file extraction
export type AssetCategory = 'image' | 'document' | 'video' | 'audio' | 'font' | 'stylesheet' | 'script' | 'other';

// Discovered asset from HTML parsing + network resources
...
export const RESOURCE_TYPE_TO_CATEGORY: Record<string, AssetCategory> = {
  image: 'image',
  media: 'video',
  font: 'font',
...
export const BINARY_LINK_EXTENSIONS = new Set([
