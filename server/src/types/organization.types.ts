...
export interface TierLimits {
  ...
  max_competitor_domains: number | null;  // null = unlimited (legacy, use max_competitors_per_site)
  // Site-centric structure
  max_sites: number | null;  // null = unlimited
  max_competitors_per_site: number | null;  // null = unlimited
}
