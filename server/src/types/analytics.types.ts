...
export interface AuditComparison {
  ...
  comparison: {
    ...
    commonIssues: IssueDiff['commonIssues'];
...
export interface UrlScoreHistoryOptions {
  urlId: string;
  url?: string;      // The actual URL string to match in audit_pages
  siteId?: string;   // Site ID to scope the query
  range?: TimeRange;
  from?: Date;
  to?: Date;
}

export interface IssueTrendOptions {
  siteId: string;
  range?: TimeRange;
  groupBy?: GroupBy;
}
