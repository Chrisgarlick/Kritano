...
const accessibilityTemplates: Record<string, FixTemplate> = {
  'image-alt': {
    ruleId: 'image-alt',
    fixType: 'code',
    language: 'html',
    ...
    explanation:
      'Add a short, descriptive alt attribute so screen readers can convey what the image shows to people who cannot see it.',
    effort: 'small',
  ...
  'empty-alt-decorative': {
    ...
    explanation:
      'If an image is purely decorative (borders, spacers, background flourishes) use an empty alt attribute and role="presentation" so assistive technology skips it.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-image-alt-text',
  },
  ...
  'html-has-lang': {
    ...
    explanation:
      'Add a lang attribute to the opening <html> tag so browsers and screen readers know which language the page is written in.',
    effort: 'small',
  ...
  'label': {
    ...
    explanation:
      'Every form field needs a visible label linked with a matching for/id pair so users know what information to enter.',
    effort: 'small',
    learnMoreUrl: '/blog/improve-accessibility-score-20-points-2-hours',
  },
  ...
  'button-name': {
    ...
    explanation:
      'Give every button accessible text — either visible text inside the button or an aria-label attribute — so screen reader users know what it does.',
    effort: 'small',
    learnMoreUrl: '/blog/improve-accessibility-score-20-points-2-hours',
  },
  ...
  'heading-order': {
    ...
    explanation:
      'Headings should follow a logical order (H1, then H2, then H3) without skipping levels. This helps screen reader users navigate the page structure.',
    effort: 'medium',
    learnMoreUrl: '/blog/improve-accessibility-score-20-points-2-hours',
  },
  ...
  'color-contrast': {
    ...
    explanation:
      'The text colour does not stand out enough against its background. Increase the contrast ratio to at least 4.5:1 for normal text or 3:1 for large text.',
    effort: 'small',
    learnMoreUrl: '/blog/improve-accessibility-score-20-points-2-hours',
  },
  ...
  'bypass': {
    ...
    explanation:
      'Add a "Skip to main content" link at the top of the page so keyboard users can jump past the navigation without tabbing through every menu item.',
    effort: 'small',
    learnMoreUrl: '/blog/improve-accessibility-score-20-points-2-hours',
  },
  ...
  'aria-hidden-focus': {
    ...
    variables: ['content'],
    fallbackTemplate:
      '<!-- Remove tabindex="0" or interactive elements from aria-hidden containers -->\n<div aria-hidden="true">\n  <!-- Decorative content only — no links, buttons or inputs -->\n</div>',
    explanation:
      'Elements hidden from screen readers (aria-hidden="true") must not be focusable. Remove any tabindex or interactive controls from inside the hidden container.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'aria-label': {
    ...
    explanation:
      'Add an aria-label to give the element an accessible name when visible text alone is not sufficient to convey its purpose.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'input-type': {
    ...
    fallbackTemplate:
      '<!-- Use the correct type for better mobile keyboards and validation -->\n<input type="email" id="email" name="email">\n<input type="tel" id="phone" name="phone">\n<input type="url" id="website" name="website">',
    explanation:
      'Set the correct input type (email, tel, url, number, etc.) so mobile browsers show the right keyboard and browsers can validate entries automatically.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'tabindex': {
    ...
    fallbackTemplate:
      '<!-- Replace positive tabindex values with 0 or remove them -->\n<!-- Bad:  <div tabindex="5"> -->\n<!-- Good: <div tabindex="0"> -->\n\n<!-- Better yet, use naturally focusable elements: -->\n<button>Click me</button>',
    explanation:
      'A positive tabindex (1, 2, 3 ...) forces an unnatural tab order. Use tabindex="0" to follow the document order, or remove it entirely and use native interactive elements like <button> and <a>.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'empty-heading': {
    ...
    fallbackTemplate:
      '<!-- Remove empty headings or add meaningful text -->\n<!-- Bad:  <h2></h2> or <h2> </h2> -->\n<!-- Good: <h2>Our services</h2> -->',
    explanation:
      'Headings must contain text so screen reader users can understand the page structure. Either add descriptive text or remove the empty heading tag.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'link-name': {
    ...
    fallbackTemplate:
      '<!-- Option 1: Visible link text -->\n<a href="/pricing">View pricing plans</a>\n\n<!-- Option 2: aria-label for icon-only links -->\n<a href="/pricing" aria-label="View pricing plans">\n  <svg aria-hidden="true">...</svg>\n</a>',
    explanation:
      'Every link needs descriptive text — either visible words or an aria-label — so users know where the link goes before clicking it.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'duplicate-id': {
    ...
    fallbackTemplate:
      '<!-- Every id attribute must be unique on the page -->\n<!-- Bad:  two elements with id="header" -->\n<!-- Good: id="site-header" and id="page-header" -->',
    explanation:
      'Each id attribute must appear only once per page. Duplicate IDs break label associations and cause unpredictable behaviour for assistive technology.',
    effort: 'small',
    learnMoreUrl: '',
  },
};
...
const seoTemplates: Record<string, FixTemplate> = {
  'missing-title': {
  ...
  'missing-meta-description': {
    ...
    fallbackTemplate:
      '<meta name="description" content="A concise summary of this page in 150-160 characters that encourages people to click through from search results.">',
    explanation:
  ...
  'missing-canonical': {
    ...
    explanation:
      'Add a canonical tag inside <head> pointing to the preferred version of the page. This prevents duplicate-content issues when the same page is accessible via multiple URLs.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'missing-h1': {
    ...
    explanation:
      'Every page should have exactly one H1 heading that clearly describes the page topic. It helps search engines and screen readers understand the page.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'multiple-h1': {
    ...
    explanation:
      'There should be only one H1 per page. Change any extra H1 tags to H2 so the page has a clear, single main heading.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'broken-link': {
    ...
    fallbackTemplate:
      '<!-- Update the broken link to a working URL or remove it -->\n<a href="https://www.example.com/valid-page">Link text</a>',
    explanation:
      'This link points to a page that returns an error. Update the href to a working URL, redirect the broken page, or remove the link entirely.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'no-structured-data': {
    ...
    explanation:
      'Add structured data (JSON-LD) to help search engines understand what the page is about. This can unlock rich results like star ratings, FAQs and breadcrumbs.',
    effort: 'medium',
  ...
  'missing-og-title': {
    ...
    explanation:
      'Add Open Graph meta tags so your page looks great when shared on Facebook, LinkedIn and other social platforms.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'missing-hreflang': {
    ...
    explanation:
      'If your site is available in multiple languages, add hreflang tags so search engines serve the right version to each audience.',
    effort: 'medium',
    learnMoreUrl: '',
  },
  ...
  'noindex-page': {
    ...
    explanation:
      'This page has a noindex tag which tells search engines not to include it in results. Remove it if you want the page to be found via search.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'redirect-chain': {
    ...
    fallbackTemplate:
      '# Nginx example: point directly to the final destination\nrewrite ^/old-page$ /final-page permanent;\n\n# Apache .htaccess example:\nRedirect 301 /old-page https://www.example.com/final-page',
    explanation:
      'This URL redirects through multiple steps before reaching the final page. Update the redirect to go directly to the destination to save load time and preserve link authority.',
    effort: 'medium',
    learnMoreUrl: '',
  },
  ...
  'thin-content': {
    ...
    language: 'text',
    template:
      'This page has very little text content ({{wordCount}} words). Aim for at least 300 words of useful, original content.',
    variables: ['wordCount'],
    fallbackTemplate:
      'This page has very little text content. Aim for at least 300 words of useful, original content that answers your visitors\' questions.',
    explanation:
      'Pages with very little text are harder for search engines to rank. Add meaningful content that helps visitors — aim for at least 300 words.',
    effort: 'large',
    learnMoreUrl: '',
  },
  ...
  'missing-alt-text': {
    ...
    explanation:
      'Add a descriptive alt attribute to every informational image. This helps visually impaired users and improves SEO image indexing.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-image-alt-text',
  },
...
const securityTemplates: Record<string, FixTemplate> = {
  'missing-csp': {
    ruleId: 'missing-csp',
    fixType: 'config',
    language: 'config',
    ...
    explanation:
      'A Content Security Policy tells browsers which sources of content are allowed, helping prevent cross-site scripting (XSS) and data injection attacks.',
    effort: 'large',
  ...
  'missing-x-frame-options': {
    ...
    explanation:
      'This header prevents your pages from being loaded inside iframes on other sites, which stops clickjacking attacks where someone overlays your page with a malicious UI.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'missing-hsts': {
    ...
    variables: ['maxAge'],
    fallbackTemplate:
      '# Add to your server response headers (HTTPS only)\nStrict-Transport-Security: max-age=31536000; includeSubDomains; preload\n\n# Nginx:\nadd_header Strict-Transport-Security "max-age=31536000; includeSubDomains; preload" always;\n\n# Apache:\nHeader always set Strict-Transport-Security "max-age=31536000; includeSubDomains; preload"',
    explanation:
      'HSTS tells browsers to always use HTTPS when visiting your site, preventing man-in-the-middle attacks and accidental HTTP connections.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'missing-x-content-type-options': {
    ...
    explanation:
      'This one-word header stops browsers from guessing (MIME-sniffing) the content type of a file, which can prevent certain types of attack.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'form-action-http': {
    ...
    fallbackTemplate:
      '<!-- Change http:// to https:// in form actions -->\n<!-- Before: <form action="http://example.com/submit"> -->\n<form action="https://example.com/submit" method="post">',
    explanation:
      'This form sends data over an insecure HTTP connection. Change the action URL to HTTPS so submitted data (passwords, personal details) is encrypted in transit.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'mixed-content-script': {
    ...
    explanation:
      'An HTTPS page is loading a script over insecure HTTP. Change the URL to HTTPS — most CDNs support it. Mixed content can be blocked by browsers and weakens security.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'missing-referrer-policy': {
    ...
    explanation:
      'The Referrer-Policy header controls how much URL information is shared when users click links to other sites. "strict-origin-when-cross-origin" is a good default.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'missing-permissions-policy': {
    ...
    explanation:
      'The Permissions-Policy header lets you disable browser features (camera, microphone, geolocation) that your site does not use, reducing the attack surface.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'server-version-exposed': {
    ...
    explanation:
      'Your server is revealing its software name and version number. Hide this information so attackers cannot easily look up known vulnerabilities for that version.',
    effort: 'small',
    learnMoreUrl: '/blog/complete-guide-website-security-headers',
  },
  ...
  'insecure-cookie': {
    ...
    fallbackTemplate:
      '# Set all three security flags on cookies\nSet-Cookie: session=abc123; Secure; HttpOnly; SameSite=Lax; Path=/\n\n# Express.js example:\nres.cookie("session", value, {\n  secure: true,\n  httpOnly: true,\n  sameSite: "lax",\n});',
    explanation:
      'This cookie is missing security flags. Add Secure (HTTPS only), HttpOnly (no JavaScript access) and SameSite (cross-site protection) to reduce the risk of cookie theft.',
    effort: 'small',
...
const contentTemplates: Record<string, FixTemplate> = {
  'poor-readability': {
    ruleId: 'poor-readability',
    fixType: 'content',
    language: 'text',
    template:
      'Readability score: {{score}}/100. Aim for 60+ by using shorter sentences, simpler words, and breaking up long paragraphs.',
    variables: ['score'],
    fallbackTemplate:
      'The readability score is low. Try:\n• Use shorter sentences (under 20 words each)\n• Replace jargon with everyday words\n• Break paragraphs into 2-3 sentences\n• Add subheadings every 300 words\n• Use bullet points for lists',
    explanation:
      'The text on this page is harder to read than it needs to be. Simpler writing helps more visitors understand your content and stay on the page.',
    effort: 'large',
    learnMoreUrl: '',
  },
  ...
  'no-subheadings': {
    ...
    explanation:
      'The page has no subheadings, making it difficult for readers to scan. Add H2 and H3 headings every 200-300 words to break the content into clear sections.',
    effort: 'medium',
    learnMoreUrl: '',
  },
  ...
  'wall-of-text': {
    ...
    variables: ['wordCount'],
    fallbackTemplate:
      'This section contains a very long unbroken block of text. To improve readability:\n• Split into paragraphs of 2-4 sentences\n• Add a subheading above each new section\n• Use bullet points where you list items\n• Consider adding an image or diagram to break up the flow',
    explanation:
      'Large blocks of text without breaks are hard to read on screen. Split them into shorter paragraphs with headings and lists so visitors can scan the content easily.',
    effort: 'medium',
    learnMoreUrl: '',
  },
  ...
  'no-images': {
    ...
    variables: [],
    fallbackTemplate:
      'This page contains no images. Consider adding:\n• A hero image at the top\n• Screenshots or diagrams to illustrate key points\n• Photos to build trust and engagement\n\nRemember to include descriptive alt text on every image.',
    explanation:
      'Pages without any images tend to feel less engaging. Adding relevant visuals helps visitors stay on the page longer and understand your content better.',
    effort: 'medium',
  ...
  'no-cta': {
    ...
    explanation:
      'This page has no clear call-to-action. Tell visitors what to do next — whether that is signing up, getting in touch, or reading more.',
    effort: 'medium',
    learnMoreUrl: '',
  },
  ...
  'no-internal-links': {
    ...
    explanation:
      'This page has no links to other pages on your site. Internal links help visitors discover more content and help search engines understand your site structure.',
    effort: 'small',
    learnMoreUrl: '',
  },
  ...
  'outdated-content': {
    ...
    language: 'text',
    template:
      'This content appears outdated (last modified {{lastModified}}). Review and update facts, statistics and links.',
    variables: ['lastModified'],
    fallbackTemplate:
      'This content appears to be outdated. Review and update:\n• Statistics and data points\n• External links (check for broken ones)\n• Product/service information\n• Dates and time-sensitive references\n• Add a "Last updated" date to build trust',
    explanation:
      'Content that references old dates or information can hurt your credibility with both visitors and search engines. Review it regularly to keep it accurate.',
    effort: 'large',
    learnMoreUrl: '',
  },
  ...
  'keyword-stuffing': {
    ...
    language: 'text',
    template:
      'The keyword "{{keyword}}" appears {{density}}% of the time ({{occurrences}} times). Aim for 1-2% density.',
    variables: ['keyword', 'density', 'occurrences'],
    fallbackTemplate:
      'Your target keyword appears too many times on this page. To fix it:\n• Reduce keyword density to 1-2%\n• Use natural synonyms and variations instead\n• Write for people first, search engines second\n• Read the text aloud — if it sounds forced, rewrite it',
    explanation:
      'Repeating the same keyword too many times can look spammy to search engines and may lead to a ranking penalty. Use natural language and synonyms instead.',
    effort: 'medium',
    learnMoreUrl: '',
  },
  ...
  'short-content': {
    ...
    language: 'text',
    template:
      'This page has only {{wordCount}} words. Consider expanding to at least 300 words with useful, original content.',
    variables: ['wordCount'],
    fallbackTemplate:
      'This page has very little content. Consider expanding it with:\n• More detail about the topic\n• Answers to common questions\n• Examples or case studies\n• Related information visitors might find useful',
    explanation:
      'Pages with very little text are harder for search engines to rank and less helpful for visitors. Aim for at least 300 words of quality content.',
    effort: 'large',
    learnMoreUrl: '',
  },
  ...
  'no-multimedia': {
    ...
    variables: [],
    fallbackTemplate:
      'This page has no multimedia content. Consider adding:\n• Relevant images with descriptive alt text\n• An explanatory video or animation\n• Infographics or diagrams\n• Charts or data visualisations\n\nMultimedia makes content more engaging and easier to understand.',
    explanation:
      'Pages without any media (images, video, diagrams) tend to have lower engagement. Adding relevant visuals helps visitors understand and remember your content.',
    effort: 'medium',
    learnMoreUrl: '/blog/image-optimisation-biggest-performance-win',
  },
};
...
function extractVariable(
  ...
  switch (varName) {
    ...
    case 'inputId': {
      ...
      if (selector) return selector.replace(/[^a-zA-Z0-9-_]/g, '');
      return null;
    }
    case 'inputType': {
      if (snippet) {
 ...
 */
export function resolveFixSnippet(
  ruleId: string,
  context: {
    selector?: string;
    snippet?: string;
